...
**Fermentation-derived molecules:** Statins (cholesterol drugs), immunosuppressants, vitamins (including B7/biotin), enzymes (including serratiopeptidase), probiotics. These use living microorganisms (bacteria, fungi, yeast) to produce the target molecule. Capital-intensive, process-science-intensive, very hard to replicate.

**Small molecules via custom synthesis:** Traditional pharmaceutical chemistry at scale. Unit II at Harohalli is Anthem's large-scale custom synthesis hub: 376 kL capacity, FDA-approved.

**RNAi (RNA interference) and oligonucleotides:** Next-generation gene-silencing therapeutics. Small but growing segment; complex to manufacture.

**Biosimilars:** Lower-cost versions of branded biological drugs once patents expire. Anthem makes biosimilars commercially and has them in the specialty ingredients portfolio.

In short: Anthem is not a commodity manufacturer. It works on some of the most complex, highest-margin, most technically demanding therapeutics in global pharma. That's what underpins the 43% EBITDA margins.
...
Anthem sits at the premium end of that opportunity. The CRDMO model means it's not competing on price for commodity manufacturing. It's competing on integrated capability across next-generation modalities.
...
The insight he was acting on: global pharma companies were being squeezed by rising R&D costs and declining drug approval rates. Outsourcing the entire development and manufacturing process (not just the manufacturing) was the answer. India had the chemistry talent. Nobody was building a comprehensive end-to-end platform for it.

**2006–2020:** Building the capabilities from scratch. Fermentation was central to the thesis from day one: the hardest, most capital-intensive, most technically demanding part of pharmaceutical manufacturing. Most labs avoid it. Anthem leaned in.

**2020–2025:** Growth phase. Revenue compounds at ~32% annually from FY23 to FY25. Commercial molecules increase from 10 to 14. The pipeline deepens.

**July 2025:** IPO at ₹570 per share. 67x oversubscribed. Listing price: ₹723, a 27% premium on day one. Ajay Bhardwaj, now 65, appears on Forbes' Billionaires list with a net worth of $2.4 billion. He is named an EY Entrepreneur of the Year 2025 finalist and is a founder-trustee of Plaksha University.
...
Among global CRDMOs with meaningful fermentation capability, it is a short list. Among Indian companies, Anthem is in a different category. A competitor cannot close that gap in five years.
...
### What Is Inventory Destocking?

Pharma companies (and the distributors and institutional buyers downstream) don't order drugs just-in-time. They carry inventory buffers. When they anticipate strong demand, they build those buffers up (overstocking). When buffers are full, they work through existing stock before ordering new production (destocking). The CRDMO sees this as a sudden, sharp drop in volumes, not because the underlying drug demand fell, but because the ordering cycle paused.
...
On **June 18, 2026**, while the stock was in the ₹744-750 range following the Q3 correction, a **₹1,274 crore block deal** executed: 1.71 crore shares at ₹744.80/share, representing a **3.05% stake**.

**Seller:** Aruna Ganesh (promoter family). Promoter holding dropped from 74.68% to 71.63%.
...
- Nordea Asset Management (Luxembourg)
...
*Insurance and AIF:*
- PI Opportunities AIF V LLP (affiliate of **Premji Invest**)
...
APIs and small molecules account for ~52% of the global CDMO market today. But large molecules and biologics (precisely where Anthem's fermentation and ADC capabilities are differentiated) are growing at ~15% CAGR, the fastest segment. GLP-1 peptides and ADC oncology drugs are two of the hottest categories in global pharma right now. Anthem is in both.
...
Management is confident in sustaining 20%+ growth but has not provided specific FY27 guidance. At 20% PAT growth, FY27 PAT would be approximately ₹710 crore.

<div class="table-scroll">

| FY27 Forward PE | Implied Market Cap | Share Price (~56.7 Cr shares) | vs ₹750 |
|---|---:|---:|:---:|
...
<table class="sh-table">
  <thead>
    <tr>
      <th></th>
      <th>Jul '25 (listing)</th>
      <th>Sep '25</th>
      <th>Dec '25</th>
      <th>Mar '26</th>
      <th>Jun '26 (post block deal)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td class="sh-label">Promoter</td>
      <td>~76%</td>
      <td>~75%</td>
      <td>~75%</td>
      <td>74.7%</td>
...
*Listing-period and Sep/Dec '25 figures are approximate. Jun '26 post-block-deal promoter figure is confirmed (71.63%). FII/DII Jun '26 breakdown not yet published.*

DII holding has built steadily every quarter from 7% at listing to 11.5% by March 2026. FII at 1.3% is still very early. There is significant room if global funds start engaging the India CRDMO story. The June 2026 block deal added names like Societe Generale, Nordea, and Prudential to the foreign holder register, which should show up in Jun 26 disclosure.

The pattern is consistent: institutions accumulating, retail declining, promoter selling through secondary transactions (not dilution). The buyers in each case are sophisticated long-term holders, not traders.
...
The story here is specific and testable: the business took a destocking hit in Q3 FY26, management said destocking is behind them and restocking is coming, and a ₹1,274 crore block deal was executed at ₹744.80 by some of the most sophisticated institutional investors in India and globally.
...
- [Q3 FY26 Results and Guidance Cut: Prysm](https://www.prysm.fi/news/anthem-biosciences-q3fy26-revenue-423-crore-pat-93-crore-9mfy26-revenue-1513-crore)
- [Anthem Biosciences Annual Report FY26: ScanX](https://scanx.trade/stock-market-news/companies/anthem-biosciences-annual-report-fy-2025-26-strong-revenue-and-profit-growth-unit-iv-expansion-underway/44394471)
- [Anthem Biosciences Q1 FY26: ScanX](https://scanx.trade/stock-market-news/earnings/anthem-biosciences-reports-strong-q1-fy26-results-with-60-revenue-growth/17060674)
- [Anthem Biosciences Q2 & H1 FY26: Multibagg](https://www.multibagg.ai/blogs/88326-anthem-biosciences-q2-h1-fy26_ANTHEM_Q2_FY26_MBEQU4937)
- [Block Deal: Upstox](https://upstox.com/news/market-news/stocks/anthem-biosciences-sees-1-7-crore-shares-changing-hands-as-societe-generale-prudential-among-others-buy-3-stake/article-195653/)
- [Block Deal: Medical Dialogues](https://medicaldialogues.in/news/industry/health-investments/global-investors-acquire-3-stake-in-anthem-biosciences-for-rs-1275-crore-173408)
- [Helping Drug Firms Save Time And Money: Forbes](https://www.forbes.com/sites/anuraghunathan/2026/06/09/helping-drug-firms-save-time-and-money-turned-this-indian-entrepreneur-into-a-billionaire/)
- [Anthem Bio knows the virtues of "pharma renting": The Ken](https://the-ken.com/story/anthem-bios-rs-3395-crore-ipo-is-riding-the-crazy-run-that-cohance-started/)
- [Who's Who of Indian Pharma CDMOs: Nivezo Substack](https://nivezo.substack.com/p/the-whos-who-of-indian-pharma-cdmos)
- [Anthem Biosciences Peers Comparison: IPO Central](https://ipocentral.in/anthem-biosciences-peers-comparison-analysis/)
- [What is a CRDMO?: IntuitionLabs](https://intuitionlabs.ai/articles/what-is-crdmo)
- [CRDMO Dominance vs CDMO: Mantell Associates](https://www.mantellassociates.com/the-dominance-of-crdmos-compared-to-cdmos/)
- [India CDMO Market Set to Double: PharmaSource](https://pharmasource.global/content/indias-cdmo-market-set-to-double-in-the-next-5-years/)
- [Anthem ADC Capabilities: anthembio.com](https://anthembio.com/antibody-drug-conjugates-adcs/)
